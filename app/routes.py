...
from app.forms import LoginForm, RegistrationForm, EditProfileForm, EmptyForm, \
    PostForm, ResetPasswordRequestForm, ResetPasswordForm, MessageForm
...
def user(username):
    ...
    prev_url = url_for('user', username=user.username, page=posts.prev_num) \
        if posts.has_prev else None
    form = EmptyForm()
    return render_template('user.html', title='profile', posts=posts.items, next_url=next_url, prev_url=prev_url, user=user, profile_picture=profile_picture, form=form)
...
def save_picture(form_picture):
    ...
    prev_picture = os.path.join(app.root_path, 'static/profile_pictures', current_user.profile_picture)
    if current_user.profile_picture != 'default.jpg' and os.path.exists(prev_picture):
